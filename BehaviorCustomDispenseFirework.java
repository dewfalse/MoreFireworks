...
public class BehaviorCustomDispenseFirework extends BehaviorDefaultDispenseItem {

    final MinecraftServer mcServer;

    public BehaviorCustomDispenseFirework(MinecraftServer par1MinecraftServer)
    {
    ...
    public ItemStack dispenseStack(IBlockSource par1IBlockSource, ItemStack par2ItemStack)
    {
        ...
        EntityCustomFireworkRocket var10 = new EntityCustomFireworkRocket(par1IBlockSource.getWorld(), var4, var6, var8, par2ItemStack);
